...
CREATE SEQUENCE "categories_categoryID_seq" INCREMENT  MINVALUE  MAXVALUE  CACHE ;

CREATE TABLE "s3964"."categories" (
                                      "categoryID" integer DEFAULT nextval('"categories_categoryID_seq"') NOT NULL,
...
CREATE SEQUENCE "customers_customerID_seq" INCREMENT  MINVALUE  MAXVALUE  CACHE ;

CREATE TABLE "s3964"."customers" (
...
CREATE SEQUENCE "employees_employeeID_seq" INCREMENT  MINVALUE  MAXVALUE  CACHE ;

CREATE TABLE "s3964"."employees" (
...
DROP SEQUENCE IF EXISTS "orderdetails_orderDetailID_seq";
CREATE SEQUENCE "orderdetails_orderDetailID_seq" INCREMENT  MINVALUE  MAXVALUE  CACHE ;

CREATE TABLE "s3964"."orderdetails" (
                                        "orderDetailID" integer DEFAULT nextval('"orderdetails_orderDetailID_seq"') NOT NULL,
...
DROP SEQUENCE IF EXISTS "shippers_shipperID_seq";
CREATE SEQUENCE "shippers_shipperID_seq" INCREMENT  MINVALUE  MAXVALUE  CACHE ;

CREATE TABLE "s3964"."shippers" (
                                    "shipperID" integer DEFAULT nextval('"shippers_shipperID_seq"') NOT NULL,
...
DROP SEQUENCE IF EXISTS "suppliers_supplierID_seq";
CREATE SEQUENCE "suppliers_supplierID_seq" INCREMENT  MINVALUE  MAXVALUE  CACHE ;

CREATE TABLE "s3964"."suppliers" (
                                     "supplierID" integer DEFAULT nextval('"suppliers_supplierID_seq"') NOT NULL,
...
INSERT INTO "suppliers" ("supplierID", "supplierName", "contactName", "address", "city", "postalCode", "country", "phone") VALUES
                                                                                                                               ...
                                                                                                                               (12,	'Plutzer Lebensmittelgro�m�rkte AG',	'Martin Bein',	'Bogenallee 51',	'Frankfurt',	'60439',	'Germany',	'(069) 992755'),
