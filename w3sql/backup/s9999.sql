...
CREATE SEQUENCE customers_customerid_seq INCREMENT 1 MINVALUE 1 MAXVALUE 2147483647 CACHE 1;

CREATE TABLE "s9999"."customers" (
...
INSERT INTO "customers" ("customerid", "customername", "contactname", "address", "city", "postalcode", "coutry") VALUES
...
CREATE TABLE "s9999"."orderdetails" (
...
CREATE SEQUENCE orders_orderid_seq INCREMENT 1 MINVALUE 1 MAXVALUE 2147483647 CACHE 1;

CREATE TABLE "s9999"."orders" (
...
CREATE SEQUENCE products_productid_seq INCREMENT 1 MINVALUE 1 MAXVALUE 2147483647 CACHE 1;

CREATE TABLE "s9999"."products" (
...
INSERT INTO "products" ("productid", "productname", "supplierid", "categoryid", "unit", "price") VALUES
                                                                                                     ...
                                                                                                     (61,	'Sirop d''�rable',	29,	2,	'24 - 500 ml bottles',	28.50),
                                                                                                     ...
                                                                                                     (71,	'Fl�temysost',	15,	4,	'10 - 500 g pkgs.',	21.50),
